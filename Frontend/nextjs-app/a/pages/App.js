...
import {Ecommerce, Orders, Pyramid, Area, Employees, Stacked, Customers, Bar,Line,Calendar, Kanban,ColorPicker, Editor, Pie} from '.';
    ...
    <div className="fixed right-4 bottom-4" style={{ zIndex :'1000'}}>
      <TooltipComponent content="Settings" position="Top">
        ...
        style={{ background: 'blue', borderRadius: '50%' }}>
          <FiSettings className="h-6 w-6 text-main-dark-bg" />
        </button>
      </TooltipComponent>
    </div>
    {activeMenu ?(
